...
- Chef: 250×250 px, overlap visual com o logo via `translate-x` negativo (`-translate-x-24 lg:-translate-x-44`). Agrupamento compensado com `pl-16 lg:pl-28` para manter o centro visual.
