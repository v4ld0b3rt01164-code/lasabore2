  ...
  return (
    <footer className="w-full flex justify-center bg-[#0d0d0d] border-t border-[#121212]/10 py-10 sm:py-12">
      <div className="container-section">
        <div className="flex flex-col sm:flex-row justify-between items-start gap-8">
          ...
          <div className="flex flex-col items-start sm:items-end gap-3">
            <a
              ...
              className="flex items-center gap-2 text-sm text-white hover:text-italia-red transition-colors"
            >
        ...
        <div className="mt-8 pt-6 border-t border-bg/8 w-full text-center">
