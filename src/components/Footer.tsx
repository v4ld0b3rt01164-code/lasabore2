export default function Footer() {
  return (
    <footer id="contato" className="w-full flex justify-center bg-black border-t border-[rgba(255,255,255,0.04)] py-16 sm:py-20">
      <div className="container-section">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
          <div className="text-center">
            <img src="/images/logo.png" alt="La Sabore" className="h-14 w-auto object-contain mb-3 mx-auto" />
            <p className="text-sm text-[rgba(255,255,255,0.5)] leading-relaxed max-w-xs mx-auto">
          ...
          <div>
            <div className="flex flex-col gap-3 mt-6 sm:mt-0">
              <a href="https://www.instagram.com/lasaboremiguelopolis/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[rgba(255,255,255,0.5)] hover:text-[#dc2626] transition-colors">
              ...
              <a href="https://wa.me/5516992315122" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[rgba(255,255,255,0.5)] hover:text-[#dc2626] transition-colors">
        ...
        <div className="mt-16 pt-8 border-t border-[rgba(255,255,255,0.04)] text-center">
          <p className="text-xs text-[rgba(255,255,255,0.35)]">© 2026 La Sabore. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
