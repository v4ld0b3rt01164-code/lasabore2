  ...
  return (
    <footer className="w-full flex justify-center bg-[#0d0d0d] border-t border-[#121212]/10 py-16 sm:py-20">
      <div className="container-section flex flex-col items-center text-center">
        ...
        <p className="text-sm text-[#F3ECD2]/65 leading-relaxed font-medium max-w-xs">
          Sua pizza artesanal em Miguelópolis.
        </p>

        <div className="mt-10 pt-8 border-t border-[#F3ECD2]/8 w-full">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#F3ECD2]/55 mb-4">
            // acompanhe
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6">
            <a
              ...
              className="flex items-center gap-2 text-sm text-[#F3ECD2] hover:text-[#DC2626] transition-colors"
            >
