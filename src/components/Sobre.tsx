        ...
        <motion.div {...fadeIn('left')}>
          ...
          <div className="space-y-5 text-justify text-[rgba(255,255,255,0.55)] leading-relaxed">
            <p>
              ...
              <span className="text-[#dc2626] highlight">paixão</span>. Foi desse sentimento que nasceu a La Sabore
              Pizzaria. Antes de ser um negócio, ela era um{' '}
              <span className="text-[#dc2626] highlight">sonho</span>: levar para Miguelópolis uma experiência
              diferente, com sabores{' '}
              <span className="text-[#dc2626] highlight">exclusivos</span>, ingredientes de qualidade e um cuidado
            ...
            <p>
              ...
              <span className="text-[#dc2626] highlight">bordas recheadas</span> se tornaram um dos grandes
              <span className="text-[#dc2626] highlight"> diferenciais</span> da La Sabore, conquistando clientes e
              transformando cada fatia em uma surpresa.
            </p>

            <p>
              Mais do que preparar pizzas, buscamos criar{' '}
              <span className="text-[#dc2626] highlight">momentos</span>. Queremos que cada pedido reúna famílias,
          ...
          <div className="mt-8 p-5 rounded-xl bg-[rgba(220,38,38,0.08)] border border-[rgba(220,38,38,0.15)] text-center">
            ...
            <p className="text-sm text-[rgba(255,255,255,0.6)] italic">
              Feita com <span className="text-[#dc2626] highlight">paixão</span>. Servida com{' '}
