          ...
          {items.map(item => {
            ...
            return item.href ? (
              <a
                ...
                className="block bg-white/80 border border-[#121212]/10 rounded-2xl p-6 sm:p-8 transition-colors duration-300 hover:border-[#121212]/25 hover:-translate-y-1"
              >
                {Inner}
              </a>
            ) : (
              <div
                key={item.title}
                className="bg-white/80 border border-[#121212]/10 rounded-2xl p-6 sm:p-8 transition-colors duration-300 hover:border-[#121212]/25"
              >
                {Inner}
              </div>
            )
