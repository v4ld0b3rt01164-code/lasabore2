...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {mobileOpen && (
        <div className="fixed top-16 left-0 right-0 bottom-0 bg-[rgba(10,10,10,0.97)] backdrop-blur-xl flex flex-col items-center justify-center gap-8 z-40 md:hidden">
          {links.map(l => (
